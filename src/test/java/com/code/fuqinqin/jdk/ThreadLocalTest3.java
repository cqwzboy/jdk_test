...
//        withoutThreadPool(10);
    ...
    public static void threadPoolExecute(Integer var1,Integer var2, int index){
        System.out.println(index + " - " + var1 + " - " + var2 + " - " + MyContextHolder.get());
        executorService.execute(()->assert1(var1,var2, index));
    }
    ...
    public static void assert1(Integer var1,Integer var2, int index){
        System.out.println(index + " - "  + var1 + " - " + var2 + " - " + MyContextHolder.get() + " - " + String.valueOf(MyContextHolder.get()*var2==var1*var2));
    }
